...
using ServerMessenger.Infrastructure.Repositories;
using System.Reflection;
using System.Text;
using Microsoft.OpenApi.Models;
using ServerMessenger.Core.Interfaces;
using ServerMessenger.Infrastructure.Cassandra;
using ServerMessenger.Application.Validators;
using ServerMessenger.Application.Interface.Services;
using ServerMessenger.Application.Services;
using ServerMessenger.Application.AutoMapper;
using ServerMessenger.Infrastructure.Hubs;
...
builder.Services.AddAutoMapper(cfg =>
{
    ...
    cfg.AddProfile<GroupMemberProfile>();
});
